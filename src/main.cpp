...
int main()
{
    ...
    unique_ptr<Vector3D> v0 = make_unique<Vector3D>();
    ...
    unique_ptr<Vector3D> v1 = make_unique<Vector3D>(3);
...
/*
        v1.print();
        //выведем вектор v1 в консоль
        std::cout << std::endl;
        std::cout << "the vector v1 is "<< std::endl;
        std::cout << v1 << std::endl;
        ...
        //выведем указатель
        auto a = std::make_unique<Vector3D>(3);
        std::cout << *a << std::endl;
        std::cout << a << std::endl;
        a = nullptr;
     /*
